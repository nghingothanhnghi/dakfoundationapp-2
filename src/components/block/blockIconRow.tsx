...
import BlockchainIcon from "../../assets/icons/blockchain_icon.png";
import DAGIcon from "../../assets/icons/DAG-tech-blockchain_icon.png";
import EngynIcon from "../../assets/icons/speed_icon.png";
import FreeGazIcon from "../../assets/icons/free_engy-icon.png";

export const BlockIconsRow: React.FC = () => {
  const icons = [
    { src: BlockchainIcon, alt: "Cloud Service Icon 1", width: "w-28" },
    ...
    { src: DAGIcon, alt: "Cloud Service Icon 2", width: "w-28" },
    ...
    { src: EngynIcon, alt: "Cloud Service Icon 4", width: "w-[122px]" },
    { src: "https://cdn.builder.io/api/v1/image/assets/TEMP/c0b00e9b6f36a83a31ad0e10a7c336813c30a913?placeholderIfAbsent=true", alt: "Separator", width: "w-8" },
    { src: FreeGazIcon, alt: "Cloud Service Icon 5", width: "w-[100px]" },
  ];
